...
namespace CQIE.LOG.Services
{
    public interface ISysCar
    {
        ...
        public Task<string> Save_Update_CarManAsync(CQIE.LOG.Models.Delivery.Car order);
        public Task<string> Save_Del_CarAsync(int id);
        public Task<string> Save_Add_CarManAsync(CQIE.LOG.Models.Delivery.Car order);
