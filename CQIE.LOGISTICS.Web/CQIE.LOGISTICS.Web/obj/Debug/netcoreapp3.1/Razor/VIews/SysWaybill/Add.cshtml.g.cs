#pragma checksum "D:\github\LOGISTICS\LOGISTICS\CQIE.LOGISTICS.Web\CQIE.LOGISTICS.Web\VIews\SysWaybill\Add.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "998bd1386d021c0c74bf18a0f5554811b9f6e5bc"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"998bd1386d021c0c74bf18a0f5554811b9f6e5bc", @"/VIews/SysWaybill/Add.cshtml")]
...
");
            ...
            <table id=""cargoTable"" class=""layui-table"">
                ...
                <tbody>
                    <tr>
                        <td style=""width: 150px""><input type=""text"" style=""border:none;"" lay-verify=""required"" name=""GoodsName"" /></td>
            ...
            EndWriteAttribute();
            WriteLiteral(@"></option>
                                <option value=""0"">小箱型</option>
                                <option value=""1"" selected>中箱型</option>
                                <option value=""2"">大箱型</option>
                            </select>
                        </td>
                        <td style=""width:200px"">
                            <select name=""ContainerCatgory"" lay-filter=""containerCategory"">
                                <option");
            BeginWriteAttribute("value", " value=\"", 7308, "\"", 7316, 0);
            EndWriteAttribute();
            WriteLiteral(@"></option>
                                <option value=""0"">小类型</option>
                                <option value=""1"" selected>中类型</option>
                                <option value=""2"">大类型</option>
                            </select>
                        </td>
                        <td style=""width: 150px""><input type=""text"" style=""border:none;"" lay-verify=""required"" name=""Amount"" /></td>
                        <td style=""width: 150px""><input type=""text"" style=""border:none;"" lay-verify=""required"" name=""ContainerNumber"" /></td>
                        <td style=""width: 150px""><input type=""text"" style=""border:none;"" lay-verify=""required"" name=""SealNumberlist"" /></td>
                        <td style=""width: 150px""><input type=""text"" style=""border:none; "" lay-verify=""required"" name=""transportationFee"" /></td>
                    </tr>
                    <!-- 可以添加更多的数据行 -->
                </tbody>
            </table>
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "998bd1386d021c0c74bf18a0f5554811b9f6e5bc14438", async() => {
            }
            );
    ...
    layui.use(['form'], function () {
        ...
        function addRow() {
            ...
            if (lastInput) {
                lastInput.addEventListener('input', function () {
                    ...
                    if (flag === 1) {
                        ...
                        // 设置行的 HTML 内容
                        newRow.innerHTML = `
                            <td style=""width: 150px""><input type=""text"" style=""border:none");
            WriteLiteral(@";"" name=""GoodsName"" /></td>
                            <td style=""width:150px"">
                                <select name=""ContainerType"">
                                    <option value=""""></option>
                                    <option value=""0"">箱型1</option>
                                    <option value=""1"" selected>箱型2</option>
                                    <option value=""2"">箱型3</option>
                                    <option value=""3"">箱型4</option>
                                    <option value=""4"">箱型5</option>
                                </select>
                            </td>
                            <td style=""width:150px"">
            ...
            WriteLiteral(@"/option>
                            ...
                            <td style=""width: 150px""><input type=""text"" style=""border:none;"" name=""SealNumberlist""  /></td>
            ...
            function getDataFromForm() {
                ...
                $('#cargoTable tbody tr').each(function () {
                    var rowData = {
                        ...
                        ContainerCategory: $(this).find('select[name=""ContainerCatgory""]').val(),
                        Amount: $(this).find('input[name=""Amount""]').val(),
                        ContainerNumber: $(this).find('input[name=""ContainerNu");
            WriteLiteral(@"mber""]').val(),
                        SealNumberlist: $(this).find('input[name=""SealNumberlist""]').val(),
