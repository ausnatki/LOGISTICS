...
layui.use(['table', 'dropdown'], function () {
    ...
    table.render({
        elem: '#test',
        url: '/SysExpenses/GetAll', // 此处为静态模拟数据，实际使用时需换成真实接口
        toolbar: '#toolbarDemo',
        ...
        cols: [[
            ...
            { field: 'back', width: '10%', title: '是否归还' },
            { field: 'time', width: '20%', title: '发货时间' },
            { field: 'production', width: '15%', title: '产值' },
